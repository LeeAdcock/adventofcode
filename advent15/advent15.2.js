  ...
  while(true) {
    ...
    for(var ingredientIndex = 0; ingredientIndex<Object.keys(ingredients).length-1; ingredientIndex++) {
      ...
      if(sum===100) {
        ...
        var calories = 
          Math.max(0, 
            (ingredients.Frosting.calories * ingredients.Frosting.amount) +
            (ingredients.Candy.calories * ingredients.Candy.amount) +
            (ingredients.Butterscotch.calories * ingredients.Butterscotch.amount) +
            (ingredients.Sugar.calories * ingredients.Sugar.amount));
